...
var file_proto_proto_rawDesc = []byte{
	...
	0x73, 0x61, 0x67, 0x65, 0x22, 0x2e, 0x0a, 0x08, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79,
	0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64,
	0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04,
	0x6e, 0x61, 0x6d, 0x65, 0x22, 0xfa, 0x01, 0x0a, 0x04, 0x42, 0x6f, 0x6f, 0x6b, 0x12, 0x0e, 0x0a,
	...
	0x52, 0x05, 0x62, 0x6f, 0x6f, 0x6b, 0x73, 0x32, 0x91, 0x01, 0x0a, 0x0b, 0x42, 0x6f, 0x6f, 0x6b,
...
var file_proto_proto_depIdxs = []int32{
	3, // 0: Book.categories:type_name -> Category
	4, // 1: Books.books:type_name -> Book
	0, // 2: BookService.Get:input_type -> Empty
	1, // 3: BookService.GetById:input_type -> Id
	4, // 4: BookService.Insert:input_type -> Book
	4, // 5: BookService.Update:input_type -> Book
	1, // 6: BookService.Delete:input_type -> Id
	5, // 7: BookService.Get:output_type -> Books
	4, // 8: BookService.GetById:output_type -> Book
	2, // 9: BookService.Insert:output_type -> Status
	2, // 10: BookService.Update:output_type -> Status
	2, // 11: BookService.Delete:output_type -> Status
